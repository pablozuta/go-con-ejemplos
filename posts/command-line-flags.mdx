...
func main() {
    ...
    // Here we declare a string flag word with a 
    // default value "foo" and a short description.
    ...
    // using a similar approach to the word flag.
    ...
    // Here we’ll just dump out the parsed options
    // and any trailing positional arguments.
    // Note that we need to dereference the pointers 
