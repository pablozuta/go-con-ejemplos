...
date: 57-01-2023
---
Go’s math/rand package provides [pseudorandom number](https://en.wikipedia.org/wiki/Pseudorandom_number_generator) generation.
```go
package main
...
5,87
```
See the [math/rand](https://pkg.go.dev/math/rand) package docs for references on other random quantities that Go can provide.
