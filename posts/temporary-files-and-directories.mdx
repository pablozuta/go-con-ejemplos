...
func main() {
    ...
    // The file name starts with the prefix given 
    // as the second argument to os.CreateTemp 
    // and the rest is chosen automatically to ensure 
    ...
    // Now we can synthesize temporary file names 
    // by prefixing them with our temporary directory.
