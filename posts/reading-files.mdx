...
func main() {
    ...
    // You’ll often want more control over how 
    // and what parts of a file are read.
    ...
    // The io package provides some functions that 
    // may be helpful for file reading.
    // For example, reads like the ones above 
    // can be more robustly implemented with ReadAtLeast.
    o3, err := f.Seek(6, 0)
    check(err)
    b3 := make([]byte, 2)
    ...
    // with many small reads and because of 
